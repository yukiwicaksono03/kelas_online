                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="caption">
                            ...
                            <h1 class="fz-55">We're a digital Wedding Agency based in Sukabumi.</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-5 offset-lg-4">
                        <div class="text mt-30">
                            <p>making us the ultimate destination for turning your dream wedding into a reality. 
                                Immerse yourself in the ease of crafting the perfect celebration, where every detail is thoughtfully curated to reflect your unique love story.
                                 Your journey begins here, where the joy of planning meets the simplicity of execution, ensuring that your wedding day is as enchanting as the love you share.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="cont mt-80">
                            <h4>Your journey begins here, where the joy of planning meets the simplicity of execution, 
                                ensuring that your wedding day is as enchanting as the love you share. Welcome to a realm where wedding dreams unfold effortlessly – your perfect day starts with us. </h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="cont">
                            <div class="text">
                                <h2 class="d-slideup wow">
                                    ...
                                    <span class="sideup-text">
                                        <span class="up-text"><span>Wedding</span>.</span>
                                    </span>
                                </h2>
                            </div>
                            <div class="accordion bord mt-40">
                                ...
                                <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                                    <div class="title">
                                        <h6 class="fz-18">The Power of Influencer</h6>
                                        <span class="ico"></span>
                                    </div>
                                ...
                                <div class="item mb-15 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="title">
                                        <h6 class="fz-18">Unique and Influential Wedding</h6>
                                        <span class="ico"></span>
                                    </div>
                                    <div class="accordion-info">
                                        <p class="fz-14">Taken possession of my entire soul, like these sweet mornings
                                ...
                                <div class="item wow fadeInUp" data-wow-delay=".5s">
                                    <div class="title">
                                        <h6 class="fz-18">We Build and Activate Wedding</h6>
                                        <span class="ico"></span>
                                    </div>
                                    <div class="accordion-info">
                                        <p class="fz-14">Taken possession of my entire soul, like these sweet mornings
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 valign">
                        <div class="cont">
                            <div>
                                <h6 class="sub-title mb-15">Since From 2023</h6>
                                ...
                                <div class="stauts d-flex mt-20">
                                    <div class="item d-flex align-items-center mt-30">
                                        ...
                                        <p class="fz-14">Happy Users <br> In Indonesia</p>
                                    </div>
                        ...
                        <div class="row md-marg">
                            <div class="col-md-4 col-6 brand box-bg">
                                <div class="item mb-30 wow fadeIn" data-wow-delay=".6s">
                                    ...
                                    <a href="#0" class="link" data-splitting>Sukabumi Wedding</a>
                                </div>
                            </div>
                            <div class="col-md-4 col-6 brand box-bg">
                                <div class="item mb-30 wow fadeIn" data-wow-delay=".6s">
                    ...
                    <div class="col-11 d-flex align-items-center">
                        <div class="valign">
                            <h2 class="fz-50 d-rotate wow">
                                <span class="rotate-text">Have Plant For Your Wedding</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="colum md-mb50">
                        ...
                        <div class="text">
                            <p class="mb-10">
                                <a href="#0">Sukabumi@wedding.com</a>
                            </p>
                            <h5>
                                <a href="#">+62 840 841 25 69</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="copyright d-flex">
                            <div class="ml-auto">
                                <p class="fz-13">© 2023 Sukabumi Wedding <span class="underline">
                            </div>
                        </div>
                    </div>
                </div>
