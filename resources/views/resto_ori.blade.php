    ...
    var formattedDate = `${parts[2]}-${parts[0]}-${parts[1]}`;
      ...
      if (confirm("Yakin dengan pesanan anda ?") == true) {
        ...
        function(data,status){
            // alert(data);
            if(data == '1'){
                window.open("https://wa.me/6281359009200?text=Halo,+saya+ingin+melakukan+reservasi Atas+nama+"+input4+"+dan No. Pic : "+input5+"+pada+tanggal+"+input1+"+ Jam+:+"+input2+"+untuk+"+input3+"+orang, Dengan+menu+sbb+:+\n+"+list_item+"+Terimakasih!");
            }
          // alert("Data: " + data + "\nStatus: " + status);
        });
        return false;
        ...
        <section class="place-details-section">
            ...
            <div class="place-slider-area overflow-hidden wow fadeInUp">
                <div class="place-slider">
                    ...
                    <div class="place-slider-item">
                        <div class="place-img">
                            <img src="assets/images/place/double-place-3.jpg" alt="Place Image">
                        </div>
                    </div>
                    <div class="place-slider-item">
                        <div class="place-img">
                            ...
                            <div class="col-xl-6">
                                <div class="tour-widget-info">
                                    ...
                                    <div class="info-box mb-20">
                                        ...
                                        <div class="info">
                                            <h4><span>Tipe Tempat</span>Hutan Di Tengah Kota</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            ...
                            <div class="place-content-wrap pt-45 wow fadeInUp">
                                ...
                                <p>Adalah tempat yang menyajikan makanan dan minuman kepada pelanggan yang datang untuk makan atau minum. Restoran biasanya memiliki beragam menu makanan yang lebih bervarian dan minuman yang pelanggan bisa pesan, dan mereka menyediakan layanan untuk makan di tempat (dine-in), pengambilan (takeout).</p>
                                <h4>Fasilitas</h4>
                                    ...
                                    <form class="sidebar-booking-form">
                                        <div class="booking-date-time mb-20">
                                            ...
                                            <div class="booking-item">
                                                <label>PIC</label>
                                                <div class="bk-item booking-text">
                                                    <input type="text" id="input5" name="input5" placeholder="No WA">
                                                </div>
                                            </div>
                                            <div class="booking-item">
                                                <label>Tanggal</label>
