    ...
    <body>
        <div class="container">
            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <a href="/admin/tambah" class="btn btn-primary">Input Item Baru</a>
                    <br/>
                    <br/>
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: {{$bg}} ;">
                                ...
                                <td>{{ $status }}</td>
                                <td>
                                    <a href="/admin/edit/{{ $p->gid }}" class="btn btn-warning">Edit</a>
                                    <a href="/admin/hapus/{{ $p->gid }}" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
